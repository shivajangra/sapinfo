                ...
                <div className="auto-container">
                    <div className="clearfix">
                        ...
                        <div className="pull-left logo-box">
                            <div className="logo"><a href="index.html"><img src={require('../../assets/images/logo.png')} alt="Logo" title="Logo" /></a></div>
                        </div>
            ...
            <div className="sticky-header">
                <div className="auto-container clearfix"> 
                    <div className="logo pull-left">
                        <a href="index.html" className="img-responsive"><img src={require('../../assets/images/logo.png')} alt="" title="" /></a>
                    </div>
