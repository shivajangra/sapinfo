...
class Home extends React.Component {
  ...
  render() { 
    return (
      ...
      {/* Call To Action*/}
      <section className="call-to-action" style={{ backgroundImage: "url("+bg+")"}}>
        <div className="auto-container">
          <h2>Have a great opportunity to <br/> manage your <span>finance</span></h2>
          <div className="btns-box">
            <a href="#"><img src={require('../assets/images/icons/app-btn.png')} alt="" /></a>
            <a href="#"><img src={require('../assets/images/icons/google-btn.png')} alt="" /></a>
          </div>
        ...
        <div className="auto-container"> 
          ...
          <div className="row clearfix">
            ...
            <div className="news-block-four col-lg-4 col-md-6 col-sm-12">
              <div className="inner-box wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                <div className="image">
                  <img src={require('../assets/images/resource/news-4.jpg')} alt="" />
                  <div className="overlay-box">
                    <a href="images/resource/news-4.jpg" data-fancybox="news" data-caption="" className="plus flaticon-plus-symbol"></a>
                  </div>
                </div>
            ...
            <div className="news-block-four col-lg-4 col-md-6 col-sm-12">
              <div className="inner-box wow fadeInUp" data-wow-delay="300ms" data-wow-duration="1500ms">
                <div className="image">
                  <img src={require('../assets/images/resource/news-5.jpg')} alt="" />
                  <div className="overlay-box">
                    <a href="images/resource/news-5.jpg" data-fancybox="news" data-caption="" className="plus flaticon-plus-symbol"></a>
                  </div>
                </div>
                <div className="lower-content">
                  <ul className="post-meta">
            ...
            <div className="news-block-four col-lg-4 col-md-6 col-sm-12">
              <div className="inner-box wow fadeInUp" data-wow-delay="600ms" data-wow-duration="1500ms">
                <div className="image">
                  <img src={require('../assets/images/resource/news-6.jpg')} alt="" />
                  <div className="overlay-box">
                    <a href="images/resource/news-6.jpg" data-fancybox="news" data-caption="" className="plus flaticon-plus-symbol"></a>
                  </div>
                </div>
                <div className="lower-content">
                  <ul className="post-meta">
        ...
        <div className="auto-container">
          ...
          <div className="carousel-outer"> 
                    <ul className="sponsors-carousel owl-carousel owl-theme">
                        <li><div className="image-box"><a href="#"><img src={require('../assets/images/clients/1.png')} alt="" /></a></div></li>
                        <li><div className="image-box"><a href="#"><img src={require('../assets/images/clients/2.png')} alt="" /></a></div></li>
                        <li><div className="image-box"><a href="#"><img src={require('../assets/images/clients/3.png')} alt="" /></a></div></li>
                        <li><div className="image-box"><a href="#"><img src={require('../assets/images/clients/4.png')} alt="" /></a></div></li>
                        <li><div className="image-box"><a href="#"><img src={require('../assets/images/clients/5.png')} alt="" /></a></div></li>
                        <li><div className="image-box"><a href="#"><img src={require('../assets/images/clients/6.png')} alt="" /></a></div></li>
                        <li><div className="image-box"><a href="#"><img src={require('../assets/images/clients/1.png')} alt="" /></a></div></li>
                        <li><div className="image-box"><a href="#"><img src={require('../assets/images/clients/2.png')} alt="" /></a></div></li>
                        <li><div className="image-box"><a href="#"><img src={require('../assets/images/clients/3.png')} alt="" /></a></div></li>
                        <li><div className="image-box"><a href="#"><img src={require('../assets/images/clients/4.png')} alt="" /></a></div></li>
