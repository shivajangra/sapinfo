...
import slider_Bg from '../assets/images/main-slider/4.png';
  ...
  render() {  
	...
	<div className="slider-outer">
		<div className="main-slider-carousel owl-carousel owl-theme">
			...
			<div className="slide style-two" style={{ backgroundImage:"url("+slider_Bg+")"}}>
		...
		<div className="business-image-box wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
			<img src={require('../assets/images/main-slider/content-image.png')} alt=""/>
		</div>
